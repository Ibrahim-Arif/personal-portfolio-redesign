    ...
    >
      ...
      <div className="p-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={
            isMobile ? {} : { delay: index * 0.15 + 0.3, duration: 0.5 }
          }
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={
              isMobile ? {} : { delay: index * 0.15 + 0.4, duration: 0.5 }
            }
          >
        ...
        <div className="flex justify-between items-end">
          <motion.p
            className="text-[#839297] text-base md:text-lg leading-relaxed pr-4 line-clamp-3 font-sans"
            initial={isMobile ? false : { opacity: 0, y: 15 }}
            whileInView={isMobile ? false : { opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={
              isMobile ? {} : { delay: index * 0.15 + 0.5, duration: 0.5 }
            }
          >
            {award.description}
          </motion.p>
